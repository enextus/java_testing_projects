...
public class EventsHelper extends HelperBase {
    ...
    public void tapOnPlusButton() {
        waiForElementAndTap(By.id("fab_main"), 5);
    }
    ...
    public void fillEventForm1(String eventTitle, String eventType, int breaks) {
        type(By.id("info_title_input"), eventTitle);
        type(By.id("info_type_input"), eventType);
        hideKeyboard();
        if (breaks > 0) {
    ...
    public int getTotalEvents() {
        ...
        int idCount = id.size();
        System.out.println("Total evenst quontity: " + idCount);
        return idCount;
    }
